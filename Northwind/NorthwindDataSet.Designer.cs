...
namespace Northwind.NorthwindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ([SupplierID] = @Original_SupplierID) AND ([CategoryID] = @Original_CategoryID) AND ([QuantityPerUnit] = @Original_QuantityPerUnit) AND ([UnitPrice] = @Original_UnitPrice) AND ([UnitsInStock] = @Original_UnitsInStock) AND ([UnitsOnOrder] = @Original_UnitsOnOrder) AND ([ReorderLevel] = @Original_ReorderLevel) AND ([Discontinued] = @Original_Discontinued))";
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductID] = @ProductID, [ProductName] = @ProductName, [SupplierID] = @SupplierID, [CategoryID] = @CategoryID, [QuantityPerUnit] = @QuantityPerUnit, [UnitPrice] = @UnitPrice, [UnitsInStock] = @UnitsInStock, [UnitsOnOrder] = @UnitsOnOrder, [ReorderLevel] = @ReorderLevel, [Discontinued] = @Discontinued WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ([SupplierID] = @Original_SupplierID) AND ([CategoryID] = @Original_CategoryID) AND ([QuantityPerUnit] = @Original_QuantityPerUnit) AND ([UnitPrice] = @Original_UnitPrice) AND ([UnitsInStock] = @Original_UnitsInStock) AND ([UnitsOnOrder] = @Original_UnitsOnOrder) AND ([ReorderLevel] = @Original_ReorderLevel) AND ([Discontinued] = @Original_Discontinued));
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, int Original_SupplierID, int Original_CategoryID, string Original_QuantityPerUnit, decimal Original_UnitPrice, short Original_UnitsInStock, short Original_UnitsOnOrder, short Original_ReorderLevel, bool Original_Discontinued) {
            ...
            if ((Original_QuantityPerUnit == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_QuantityPerUnit));
            }
            this.Adapter.DeleteCommand.Parameters[5].Value = ((decimal)(Original_UnitPrice));
            this.Adapter.DeleteCommand.Parameters[6].Value = ((short)(Original_UnitsInStock));
            this.Adapter.DeleteCommand.Parameters[7].Value = ((short)(Original_UnitsOnOrder));
            this.Adapter.DeleteCommand.Parameters[8].Value = ((short)(Original_ReorderLevel));
            this.Adapter.DeleteCommand.Parameters[9].Value = ((bool)(Original_Discontinued));
        ...
        public virtual int Insert(int ProductID, string ProductName, int SupplierID, int CategoryID, string QuantityPerUnit, decimal UnitPrice, short UnitsInStock, short UnitsOnOrder, short ReorderLevel, bool Discontinued) {
            ...
            this.Adapter.InsertCommand.Parameters[6].Value = ((short)(UnitsInStock));
            this.Adapter.InsertCommand.Parameters[7].Value = ((short)(UnitsOnOrder));
            this.Adapter.InsertCommand.Parameters[8].Value = ((short)(ReorderLevel));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((short)(UnitsInStock));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((short)(UnitsOnOrder));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((short)(ReorderLevel));
            ...
            if ((Original_QuantityPerUnit == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_QuantityPerUnit));
            }
            this.Adapter.UpdateCommand.Parameters[15].Value = ((decimal)(Original_UnitPrice));
            this.Adapter.UpdateCommand.Parameters[16].Value = ((short)(Original_UnitsInStock));
            this.Adapter.UpdateCommand.Parameters[17].Value = ((short)(Original_UnitsOnOrder));
            this.Adapter.UpdateCommand.Parameters[18].Value = ((short)(Original_ReorderLevel));
